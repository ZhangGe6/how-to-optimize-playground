...
// // try prefetch
void MMult_optim_rect2_0(cublasHandle_t handle, float *A, float *B, float *C, int M, int K, int N);
void MMult_optim_rect2_1(cublasHandle_t handle, float *A, float *B, float *C, int M, int K, int N);
void MMult_optim_rect2_2(cublasHandle_t handle, float *A, float *B, float *C, int M, int K, int N);
void MMult_optim_rect2_3(cublasHandle_t handle, float *A, float *B, float *C, int M, int K, int N);
void MMult_optim_rect2_4(cublasHandle_t handle, float *A, float *B, float *C, int M, int K, int N);
