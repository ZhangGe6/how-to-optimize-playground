...
template <
    ...
    > 
__global__ void gemm_kernel_optim_rect1_1( 
...
void MMult_optim_rect1_1(cublasHandle_t handle, float *A, float *B, float *C, const int M, const int K, const int N) {
    ...
    gemm_kernel_optim_rect1_1<BLOCK_SIZE_M, BLOCK_SIZE_K, BLOCK_SIZE_N, THREAD_SIZE_Y, THREAD_SIZE_X, ENABLE_DOUBLE_BUFFER> <<<dimGrid, dimBlock>>>(A, B, C, M, K, N);
