...
//       // c_xx_reg[i:i + 4, j + 4:j + 8]
//       C(i, j+4) = c_row_0.value[4];   C(i, j+5) = c_row_0.value[5];   C(i, j+6) = c_row_0.value[6];   C(i, j+7) = c_row_0.value[7];
//       C(i+1, j+4) = c_row_1.value[4];   C(i+1, j+5) = c_row_1.value[5];   C(i+1, j+7) = c_row_1.value[6];   C(i+1, j+7) = c_row_1.value[7];
//       C(i+2, j+4) = c_row_2.value[4];   C(i+2, j+5) = c_row_2.value[5];   C(i+2, j+7) = c_row_2.value[6];   C(i+2, j+7) = c_row_2.value[7];
//       C(i+3, j+4) = c_row_3.value[4];   C(i+3, j+5) = c_row_3.value[5];   C(i+3, j+7) = c_row_3.value[6];   C(i+3, j+7) = c_row_3.value[7];
//     }
//   }
// }